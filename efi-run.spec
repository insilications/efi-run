...
Version  : 0.3.0
Release  : 2
URL      : file:///aot/build/clearlinux/packages/efi-run/efi-run-v0.3.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/efi-run/efi-run-v0.3.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: efi-run-bin = %{version}-%{release}
...
%package bin
Summary: bin components for the efi-run package.
Group: Binaries

%description bin
bin components for the efi-run package.


%prep
%setup -q -n efi-run
cd %{_builddir}/efi-run
